...
import Esearch from '../EsearchListHoc/index';
import EPrompt from '../Prompt/index';
    ...
    renderTitle(item){
      return (
        <div className={emptyTreeNodeClass}>
          ...
          <em>------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</em>
          <div>
            {treeOptions["handlePanel"].map((Option:{node?:any,click?:any},index)=>{
              return(
