...
const cardLidtContent =`${styles['empty-card-list-content']}`
//常量
                        ...
                        {typeof items.dataIndex=="undefined"?null:
                         <Fragment>
                           <span>{items.title}</span>
                            {items.render?(
                                <Tooltip placement="top" title={items.render(item[items.dataIndex])}>
                                    <span  className={cardLidtContent}>{items.render(item[items.dataIndex])}</span>
                                </Tooltip>
                              ):(
                                <Tooltip placement="top" title={item[items.dataIndex]}>
                                  <span className={cardLidtContent}>{item[items.dataIndex]}</span>
                                </Tooltip>
                            )}
                         </Fragment>
                        } 
